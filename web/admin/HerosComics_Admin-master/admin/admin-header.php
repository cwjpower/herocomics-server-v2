...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo INC_URL ?>/css/bootstrap.min.css">
                <link rel="stylesheet" href="<?php echo INC_URL ?>/css/custom.css">
		<!-- Font Awesome -->
					...
					<div class="navbar-custom-menu pull-left">
						<ul class="nav navbar-nav">
							<li <?php echo stripos($lps_dir_path, '/users') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/users/">회원관리</a></li>
                                                        <li <?php echo stripos($lps_dir_path, '/publishers') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/publishers/">출판사 관리</a></li>
							...
							<li <?php echo stripos($lps_dir_path, '/community') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/community/">리뷰게시판 관리</a></li>

                            <li <?php echo stripos($lps_dir_path, '/story') ? 'class="active"' : ''; ?>><a href="<?php echo ADMIN_URL ?>/story/">스토리 관리</a></li>
